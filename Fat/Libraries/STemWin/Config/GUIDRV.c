...
/*********************************************************************
*
*       _FillRect    LCD_DRAWMODE_XOR 模式待优化
*/
static void _FillRect(GUI_DEVICE * pDevice, int x0, int y0, int x1, int y1) {
	...
	{
		lcd.FillRect(x0, y0, x1, y1,  LCD_COLORINDEX);
	}
}

/*********************************************************************
*
*       _DrawHLine   LCD_DRAWMODE_XOR 模式待优化
*/
static void _DrawHLine(GUI_DEVICE * pDevice, int x0, int y, int x1) {
	...
	{
		lcd.DrawHLine(x0, y, x1, LCD_COLORINDEX);
	}
}

/*********************************************************************
*
*       _DrawVLine, not optimized  未使用
*/
...
/*********************************************************************
*
*       Draw Bitmap 32 BPP, not optimized    未使用
*
* Purpose:
...
static void _DrawBitmap(GUI_DEVICE * pDevice, int x0, int y0,
  ...
  case 32:
    ...
    break;
	default:
		Debug_BitsPerPixel = BitsPerPixel;
		//while(1);
		break;
  }
}
