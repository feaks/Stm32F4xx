/** @file
 *	@brief MAVLink comm protocol testsuite generated from ground_station.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef GROUND_STATION_TESTSUITE_H
#define GROUND_STATION_TESTSUITE_H
...
static void mavlink_test_ground_station(uint8_t, uint8_t, mavlink_message_t *last_msg);

static void mavlink_test_all(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{

	mavlink_test_ground_station(system_id, component_id, last_msg);
}
#endif
...
static void mavlink_test_set_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_set_pid_t packet_in = {
		963497464,45.0,73.0,101.0
    };
	mavlink_set_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_set_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_pack(system_id, component_id, &msg , packet1.number , packet1.PID_P , packet1.PID_I , packet1.PID_D );
	mavlink_msg_set_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.number , packet1.PID_P , packet1.PID_I , packet1.PID_D );
	mavlink_msg_set_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_set_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_set_pid_send(MAVLINK_COMM_1 , packet1.number , packet1.PID_P , packet1.PID_I , packet1.PID_D );
	mavlink_msg_set_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_get_pid(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_get_pid_t packet_in = {
		963497464,963497672
    };
	mavlink_get_pid_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.number = packet_in.number;
        	packet1.type = packet_in.type;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_get_pid_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_get_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_get_pid_pack(system_id, component_id, &msg , packet1.number , packet1.type );
	mavlink_msg_get_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_get_pid_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.number , packet1.type );
	mavlink_msg_get_pid_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_get_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_get_pid_send(MAVLINK_COMM_1 , packet1.number , packet1.type );
	mavlink_msg_get_pid_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_attitude_verify(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_attitude_verify_t packet_in = {
		17.0,45.0,73.0
    };
	mavlink_attitude_verify_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.angle_x = packet_in.angle_x;
        	packet1.angle_y = packet_in.angle_y;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_verify_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_attitude_verify_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_verify_pack(system_id, component_id, &msg , packet1.angle_x , packet1.angle_y , packet1.angle_z );
	mavlink_msg_attitude_verify_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_verify_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.angle_x , packet1.angle_y , packet1.angle_z );
	mavlink_msg_attitude_verify_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_attitude_verify_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_verify_send(MAVLINK_COMM_1 , packet1.angle_x , packet1.angle_y , packet1.angle_z );
	mavlink_msg_attitude_verify_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_torque_tension(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_torque_tension_t packet_in = {
		963497464,963497672,963497880,963498088,963498296,963498504
    };
	mavlink_torque_tension_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_torque_tension_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_pack(system_id, component_id, &msg , packet1.voltage , packet1.current , packet1.rpm , packet1.torque , packet1.tension , packet1.throttle );
	mavlink_msg_torque_tension_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.voltage , packet1.current , packet1.rpm , packet1.torque , packet1.tension , packet1.throttle );
	mavlink_msg_torque_tension_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_torque_tension_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_send(MAVLINK_COMM_1 , packet1.voltage , packet1.current , packet1.rpm , packet1.torque , packet1.tension , packet1.throttle );
	mavlink_msg_torque_tension_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_torque_tension_ctrl(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_torque_tension_ctrl_t packet_in = {
		17235,17339,17443
    };
	mavlink_torque_tension_ctrl_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.auto_increase = packet_in.auto_increase;
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_ctrl_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_torque_tension_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_ctrl_pack(system_id, component_id, &msg , packet1.auto_increase , packet1.period , packet1.throttle );
	mavlink_msg_torque_tension_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_ctrl_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.auto_increase , packet1.period , packet1.throttle );
	mavlink_msg_torque_tension_ctrl_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_torque_tension_ctrl_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_torque_tension_ctrl_send(MAVLINK_COMM_1 , packet1.auto_increase , packet1.period , packet1.throttle );
	mavlink_msg_torque_tension_ctrl_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_attitude_calibration(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_attitude_calibration_t packet_in = {
		17235,17339,17443,17547,29
    };
	mavlink_attitude_calibration_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.ctrl_auto = packet_in.ctrl_auto;
        	packet1.ctrl_x = packet_in.ctrl_x;
        	packet1.ctrl_y = packet_in.ctrl_y;
        	packet1.ctrl_z = packet_in.ctrl_z;
        	packet1.calibration_flag = packet_in.calibration_flag;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_calibration_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_attitude_calibration_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_calibration_pack(system_id, component_id, &msg , packet1.ctrl_auto , packet1.calibration_flag , packet1.ctrl_x , packet1.ctrl_y , packet1.ctrl_z );
	mavlink_msg_attitude_calibration_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_calibration_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.ctrl_auto , packet1.calibration_flag , packet1.ctrl_x , packet1.ctrl_y , packet1.ctrl_z );
	mavlink_msg_attitude_calibration_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_attitude_calibration_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_attitude_calibration_send(MAVLINK_COMM_1 , packet1.ctrl_auto , packet1.calibration_flag , packet1.ctrl_x , packet1.ctrl_y , packet1.ctrl_z );
	mavlink_msg_attitude_calibration_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_scaled_ultrasonic(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_scaled_ultrasonic_t packet_in = {
		963497464,17443
    };
	mavlink_scaled_ultrasonic_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time_boot_ms = packet_in.time_boot_ms;
        	packet1.ultra = packet_in.ultra;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_scaled_ultrasonic_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_scaled_ultrasonic_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_scaled_ultrasonic_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.ultra );
	mavlink_msg_scaled_ultrasonic_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_scaled_ultrasonic_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.ultra );
	mavlink_msg_scaled_ultrasonic_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_scaled_ultrasonic_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_scaled_ultrasonic_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.ultra );
	mavlink_msg_scaled_ultrasonic_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_calibration_magmetometer(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_calibration_magmetometer_t packet_in = {
		17235,17339,17443,17547,17651,17755
    };
	mavlink_calibration_magmetometer_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.mag_x_min = packet_in.mag_x_min;
        	packet1.mag_x_max = packet_in.mag_x_max;
        	packet1.mag_y_min = packet_in.mag_y_min;
        	packet1.mag_y_max = packet_in.mag_y_max;
        	packet1.mag_z_min = packet_in.mag_z_min;
        	packet1.mag_z_max = packet_in.mag_z_max;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_calibration_magmetometer_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_calibration_magmetometer_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_calibration_magmetometer_pack(system_id, component_id, &msg , packet1.mag_x_min , packet1.mag_x_max , packet1.mag_y_min , packet1.mag_y_max , packet1.mag_z_min , packet1.mag_z_max );
	mavlink_msg_calibration_magmetometer_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_calibration_magmetometer_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.mag_x_min , packet1.mag_x_max , packet1.mag_y_min , packet1.mag_y_max , packet1.mag_z_min , packet1.mag_z_max );
	mavlink_msg_calibration_magmetometer_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_calibration_magmetometer_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_calibration_magmetometer_send(MAVLINK_COMM_1 , packet1.mag_x_min , packet1.mag_x_max , packet1.mag_y_min , packet1.mag_y_max , packet1.mag_z_min , packet1.mag_z_max );
	mavlink_msg_calibration_magmetometer_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_debugging_pid_parameters(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
	mavlink_debugging_pid_parameters_t packet_in = {
		93372036854775807ULL,963497880,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0
    };
	mavlink_debugging_pid_parameters_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.time = packet_in.time;
        	packet1.number = packet_in.number;
        	packet1.expect = packet_in.expect;
        	packet1.real = packet_in.real;
        	packet1.err = packet_in.err;
        	packet1.err_filter = packet_in.err_filter;
        	packet1.err_P = packet_in.err_P;
        	packet1.err_I = packet_in.err_I;
        	packet1.err_D = packet_in.err_D;
        	packet1.reserved = packet_in.reserved;
        
        

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_debugging_pid_parameters_encode(system_id, component_id, &msg, &packet1);
	mavlink_msg_debugging_pid_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_debugging_pid_parameters_pack(system_id, component_id, &msg , packet1.time , packet1.number , packet1.expect , packet1.real , packet1.err , packet1.err_filter , packet1.err_P , packet1.err_I , packet1.err_D , packet1.reserved );
	mavlink_msg_debugging_pid_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_debugging_pid_parameters_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time , packet1.number , packet1.expect , packet1.real , packet1.err , packet1.err_filter , packet1.err_P , packet1.err_I , packet1.err_D , packet1.reserved );
	mavlink_msg_debugging_pid_parameters_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_debugging_pid_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_debugging_pid_parameters_send(MAVLINK_COMM_1 , packet1.time , packet1.number , packet1.expect , packet1.real , packet1.err , packet1.err_filter , packet1.err_P , packet1.err_I , packet1.err_D , packet1.reserved );
	mavlink_msg_debugging_pid_parameters_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_ground_station(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_test_set_pid(system_id, component_id, last_msg);
	mavlink_test_get_pid(system_id, component_id, last_msg);
	mavlink_test_attitude_verify(system_id, component_id, last_msg);
	mavlink_test_torque_tension(system_id, component_id, last_msg);
	mavlink_test_torque_tension_ctrl(system_id, component_id, last_msg);
	mavlink_test_attitude_calibration(system_id, component_id, last_msg);
	mavlink_test_scaled_ultrasonic(system_id, component_id, last_msg);
	mavlink_test_calibration_magmetometer(system_id, component_id, last_msg);
	mavlink_test_debugging_pid_parameters(system_id, component_id, last_msg);
...
#endif // __cplusplus
#endif // GROUND_STATION_TESTSUITE_H
